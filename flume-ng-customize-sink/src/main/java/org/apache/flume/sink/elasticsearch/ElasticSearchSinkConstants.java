...
public class ElasticSearchSinkConstants {
  ...
  /**
   * The fully qualified class name of the index name builder the sink should
   * use to determine name of index where the event should be sent.
   */
  ...
  public static final String DEFAULT_CLUSTER_NAME = "es_cluster";
